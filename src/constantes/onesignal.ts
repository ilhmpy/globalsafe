...
if (process.env.REACT_APP_ENV) {
  ...
  APP_ID =
      process.env.NODE_ENV === "production" ? process.env.REACT_APP_PROD_ONESIGNAL_ID as string : process.env.REACT_APP_DEV_ONESIGNAL_ID as string;
  APP_SAFARI_ID =
      process.env.NODE_ENV === "production" ? process.env.REACT_APP_PROD_ONESIGNAL_SAFARI_ID as string : process.env.REACT_APP_DEV_ONESIGNAL_SAFARI_ID as string;
}
