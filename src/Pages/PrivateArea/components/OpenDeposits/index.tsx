    ...
    <S.Container>
      ...
      <RightSide>
        ...
        <S.BlockWrapper>
          <TitleWrap small>
            <ProgramDescTitle>
              Отложенная выплата: <QuestionIcon onClick={() => showInfo(1)} />
        ...
        <S.BlockWrapper>
          <TitleWrap small>
            <ProgramDescTitle>
              Замороженый депозит: <QuestionIcon onClick={() => showInfo(2)} />
              <QuestionInfo show={freezed}>Пояснение, что такое замороженный депозит</QuestionInfo>
            </ProgramDescTitle>
          </TitleWrap>
