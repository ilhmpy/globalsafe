  ...
  return (
    <S.Container>
        ...
        <S.Form>
            ...
            <S.FormItem>
              ...
              <Space gap={20} mb={20} column>
                ...
                <Checkbox
                  ...
                  onChange={(e) => console.log(e)}
                />
                <Checkbox label={'ПАО Сбербанк'} checked={false} onChange={(e) => console.log(e)} />
              </Space>
          ...
          <Space gap={10} mb={40}>
            <S.SubmitButton type="button" onClick={() => setShowOrderBuyModal(true)}>
              <Button primary>Опубликовать ордер</Button>
            </S.SubmitButton>

            <S.SubmitButton type="button" onClick={() => setShowOrderSellModal(true)}>
              <Button primary>Опубликовать ордер 2</Button>
            </S.SubmitButton>

            <S.SubmitButton type="button" onClick={() => setShowOrderErrorModal(true)}>
              <Button primary>Опубликовать ордер Error</Button>
            </S.SubmitButton>
          </Space>
        </S.Form>
      </RightSide>
      ...
      {/* <OrderBuyModal
        ...
        /> */}
      <OrderSellModal open={showOrderSellModal} onClose={() => setShowOrderSellModal(false)} />
