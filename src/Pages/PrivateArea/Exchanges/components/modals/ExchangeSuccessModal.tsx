...
export const ExchangeSuccessModal: FC<Props> = ({ onClose, open, exchange }: Props) => {
        ...
        <Modal onClose={onClose} open={open}>
          <S.SmallContainer>
            ...
            <S.DataList>
              <S.DataListItem>
                <Text size={14} lH={20}>
                  {exchange.owner === 'seller' ? 'Продано' : 'Куплено'}{' '}
              ...
              <S.DataListItem>
                <Text size={14} lH={20}>
                  Ваша оценка {exchange.owner === 'seller' ? 'покупателю' : 'продавцу'}:
                </Text>
                <S.ListItemDivider />
                <Text size={14} lH={20} weight={700}>
                  {Number(exchange.feedback).toFixed(1)}
                </Text>
              </S.DataListItem>
            </S.DataList>
