...
export const AdvertTable = () => {
  return (
    <S.Table>
      ...
      <S.BodyItem>
        <S.Cell>1 000 000 GLOBAL</S.Cell>
        <S.Cell>0.91</S.Cell>
        <S.Cell>910 000 EUR</S.Cell>
        <S.Cell>1 000 - 10 000 EUR</S.Cell>
        <S.Cell>
          <S.BankList>
            <S.BankItem>
              <img src={alfa} alt="" />
        ...
        <S.Cell>20 м</S.Cell>
        <S.Cell>5.0 (274)</S.Cell>
      </S.BodyItem>

      <S.BodyItem>
        <S.Cell>270 000 CWD</S.Cell>
        <S.Cell>0.92</S.Cell>
        <S.Cell>248 400 USDT</S.Cell>
        <S.Cell>100 - ∞ USDT</S.Cell>
        <S.Cell>
          <S.BankList>
