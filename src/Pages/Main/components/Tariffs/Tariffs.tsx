    ...
    <div>
      ...
      <BlockContainers>
        ...
        <BlockItem>
          ...
          <div>
            <Text>
              Приобретение АВТОМОБИЛЯ всего за 35, 40 или 45% от его
              рыночной стоимости
            </Text>
            <Text>2 НЕДЕЛЯ (35/65) с 27/02(21:00) по 06/03(20:59):</Text>
            <Text>
              Вы вносите 35% стоимости автомобиля (в CWD) на аккаунт Фонда.
              <br />
              Через 5 месяцев Фонд добавляет 65% от стоимости автомобиля
            </Text>
          </div>
          <input
            type="hidden"
          ...
          <SwiperSlide>
            <BlockItem>
              ...
              <div>
                ...
                <Text>2 НЕДЕЛЯ (35/65) с 27/02(21:00) по 06/03(20:59):</Text>
                <Text>
                  Вы вносите 35% стоимости автомобиля (в CWD) на аккаунт
                  Фонда.
                  <br /> Через 5 месяцев Фонд добавляет 65% от стоимости
                  автомобиля
                </Text>
              </div>
              <input
