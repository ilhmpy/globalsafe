    ...
    <div>
      ...
      <BlockContainers>
        ...
        <BlockItem>
          ...
          <div>
            <Text>
              Приобретение АВТОМОБИЛЯ всего за 45% от его
              рыночной стоимости
            </Text>
            <Text>4 НЕДЕЛЯ (45/55) с 13/03 (с 21:00) по 19/03 (до 23:59):</Text>
            <Text>
              Вы вносите 45% стоимости автомобиля (в CWD) на аккаунт Фонда.
              <br />
              Через 5 месяцев Фонд добавляет 55% от стоимости автомобиля
            </Text>
          </div>
          <input
            type="hidden"
          ...
          <SwiperSlide>
            <BlockItem>
              ...
              <div>
                ...
                <Text>4 НЕДЕЛЯ (45/55) с 13/03 (с 21:00) по 19/03 (до 23:59):</Text>
                <Text>
                  Вы вносите 45% стоимости автомобиля (в CWD) на аккаунт
                  Фонда.
                  <br /> Через 5 месяцев Фонд добавляет 55% от стоимости
                  автомобиля
                </Text>
              </div>
              <input
